...
Two such rods were needed, these will be mounted 20cm apart using wooden center distribution rod spacers at the top and bottom.
...
Some spacers to maintain adequate spacing are highly desirable. Some people make these rigid, I decided to use zip ties to keep things cheap and cheerful.
...
For testing I just ran the lines off in different directions through nearby trees. I didn't worry too much about symmetry or height.
